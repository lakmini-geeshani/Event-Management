...
<section class="section">
    ...
    <!--Section heading-->
    <h1 class="section-heading"align="center">PARTIES</h1>
    <!--Section sescription-->
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-6 m-b-r">
            ...
            <div class="card">
                ...
                <div class="view overlay hm-white-slight z-depth-1">
                    <img src="img/img/p2.jpg" class="img-fluid" alt="">
                    <a>
                        <div class="mask"></div>
                    </a>
                </div>
        ...
        <div class="col-lg-3 col-md-6 m-b-r">
            ...
            <div class="card">
                ...
                <!--Card image-->
                <div class="view overlay hm-white-slight z-depth-1">
                    <img src="img/img/p3.jpg" class="img-fluid" alt="">
                    <a>
                        <div class="mask"></div>
                    </a>
                </div>
        ...
        <div class="col-lg-3 col-md-6 m-b-r">
            ...
            <div class="card">
                ...
                <!--Card image-->
                <div class="view overlay hm-white-slight z-depth-1">
                    <img src="img/img/p6.jpg" class="img-fluid" alt="">
                    <a>
                        <div class="mask"></div>
                    </a>
                </div>
        ...
        <div class="col-lg-3 col-md-6 m-b-r">
            ...
            <div class="card">
                ...
                <!--Card image-->
                <div class="view overlay hm-white-slight z-depth-1">
                    <img src="img/img/p5.jpg" class="img-fluid" alt="">
                    <a>
                        <div class="mask"></div>
                    </a>
                </div>
