...
<section class="section">
    ...
    <!--Section heading-->
    <h1 class ="section-heading" align="center">WEDDINGS</h1>
    <!--Section sescription-->
    <p class="section-description">PLANNING | PRODUCTION | DESIGN | MANAGEMENT | EXPERIENTIAL MARKETING | STRATEGY | DEVELOPMENT</p>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-6 m-b-r">
            ...
            <div class="card">
                ...
                <div class="view overlay hm-white-slight z-depth-1">
                    <img src="img/img/pp2.jpg" class="img-fluid" alt="">
                    <a>
                        <div class="mask"></div>
                    </a>
                </div>
        ...
        <div class="col-lg-3 col-md-6 m-b-r">
            ...
            <div class="card">
                ...
                <!--Card image-->
                <div class="view overlay hm-white-slight z-depth-1">
                    <img src="img/img/wed6.jpg" class="img-fluid" alt="" width="500" height="1000">
                    <a>
                        <div class="mask"></div>
                    </a>
                </div>
        ...
        <div class="col-lg-3 col-md-6 m-b-r">
            ...
            <div class="card">
                ...
                <!--Card image-->
                <div class="view overlay hm-white-slight z-depth-1">
                    <img src="img/img/e3.jpg" class="img-fluid" alt="">
                    <a>
                        <div class="mask"></div>
                    </a>
                </div>
        ...
        <div class="col-lg-3 col-md-6 m-b-r">
            ...
            <div class="card">
                ...
                <!--Card image-->
                <div class="view overlay hm-white-slight z-depth-1">
                    <img src="img/img/wed7.jpg" class="img-fluid" alt="">
                    <a>
                        <div class="mask"></div>
                    </a>
                </div>
...
<div class="text-xs-center">
            <button class="btn btn-deep-purple" name="readmore">Read More</button>
        </div>
